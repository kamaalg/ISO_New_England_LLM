...
def scrape_pdfs_from_page_bfs(start_url, download_folder="pdfs2", max_depth=3):
    visited = set()
    ...
    while queue:
        ...
        for link in soup.find_all('a', href=True):
            ...
            elif is_valid_url(absolute_link, start_url) and absolute_link not in visited:
